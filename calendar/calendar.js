...
createWeekdayLetter('D', '9');
createWeekdayLetter('S', '22');
createWeekdayLetter('T', '35');
createWeekdayLetter('Q', '48');
createWeekdayLetter('Q', '61');
createWeekdayLetter('S', '74');
createWeekdayLetter('S', '87');
...
function createWeekdayLetter(letter, position)
{
    svg.append('text')
        .text(letter)
